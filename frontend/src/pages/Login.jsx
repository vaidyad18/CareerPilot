      ...
      <div className="w-full max-w-[420px] px-6">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full btn-primary !h-14 !rounded-2xl flex items-center justify-center gap-3 group !text-xs !font-bold !uppercase !tracking-widest shadow-xl shadow-blue-600/20"
          >
          ...
          <div className="pt-4 text-center">
            <p className="text-xs font-bold uppercase tracking-widest text-gray-500">
              ...
              <Link to="/signup" className="text-blue-500 ml-2 hover:text-blue-400 transition-colors inline-flex items-center gap-2">
                Join Now <Sparkles size={14} />
              </Link>
            </p>
          </div>
        </form>
